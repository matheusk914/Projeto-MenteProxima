...
function obterTextoEnviar(enviando) {
    if (enviando) return "Enviando...";
    return "Enviar Avaliação";
}

function obterTextoSalvarEdicao(enviando) {
    if (enviando) return "Salvando...";
    return "Salvar";
}
    ...
    async function enviarAvaliacao(evento) {
        ...
        try {
            if (avaliacaoEditando) {
                ...
                await cadastrarAvaliacao(dados);
                    ...
                    <form onSubmit={enviarAvaliacao}>
                        ...
                        <div className="form-botoes">
                            <button type="submit" className="btn-azul" disabled={enviando}>
                                {avaliacaoEditando
                                    ? obterTextoSalvarEdicao(enviando)
                                    : obterTextoEnviar(enviando)}
                            </button>
                            <button
                                type="button"
                                className="btn"
